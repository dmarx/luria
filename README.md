...
<!-- luria:badges -->
[![needs decision: 0](https://img.shields.io/badge/needs%20decision-0-brightgreen)](meta/decisions/README.md)
[![cited but retired: 0](https://img.shields.io/badge/cited%20but%20retired-0-brightgreen)](meta/decisions/README.md)
<!-- /luria:badges -->
...
carry no information ([DP-2](meta/design-principles.md#dp-2)).

Views come in two kinds, and the difference is whether the sources survive
([ADR-012](meta/decisions/ADR-012.md)). The changelog is **collected**: its
...
month with a generated contents list ([ADR-020](meta/decisions/ADR-020.md)). A
...
identically ([ADR-016](meta/decisions/ADR-016.md)).
...
([ADR-017](meta/decisions/ADR-017.md)).
...
mechanism → guarantee ([DP-5](meta/design-principles.md#dp-5)) — and this
...
taste gets re-litigated ([ADR-009](meta/decisions/ADR-009.md)).
...
- [Design principles](meta/design-principles.md)
- [Decisions](meta/decisions/README.md)
