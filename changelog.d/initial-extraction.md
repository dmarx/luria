...
- **Luria: the project-memory machinery, extracted from
  ...
  layers ([ADR-001](meta/decisions/ADR-001.md)), the
  fragment convention ([ADR-002](meta/decisions/ADR-002.md)),
  the generated decision index
  ([ADR-004](meta/decisions/ADR-004.md)), the
  reference-hyperlink lint
  ([ADR-005](meta/decisions/ADR-005.md)), the
  retired-document and pending-decision reports
  ([ADR-007](meta/decisions/ADR-007.md)), and the
...
- **Everything project-specific is configuration**
  ([ADR-006](meta/decisions/ADR-006.md)): paths,
...
- **The name.** The package was very nearly `chester`, after Chesterton's Fence;
  [ADR-010](meta/decisions/ADR-010.md) records that
  reasoning and [ADR-011](meta/decisions/ADR-011.md)
