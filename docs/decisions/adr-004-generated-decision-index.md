...
summary: >-
  ...
  made it both a lock ([DP-2](../design-principles.md#dp-2)) and a drifting copy
  ([DP-3](../design-principles.md#dp-3)) — in strata-g, 45 of 155 rows disagreed with
...
lock [DP-2](../design-principles.md#dp-2) names, *and* the drifting projection
[DP-3](../design-principles.md#dp-3) names, since every row duplicated data the
...
- **Keep the table, add a test that it matches.** Rung 2 of
  [DP-3](../design-principles.md#dp-3) where rung 1 is available. The test would be
