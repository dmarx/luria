...
**Cited nowhere at all** (2): [ADR-118](../../record/decisions.d/ADR-118.md), [ADR-119](../../record/decisions.d/ADR-119.md) — these are the cheapest to close, since nothing depends on the answer.
