...
**1 document cited without acknowledgement.** Not listed: 77 citations someone has already vouched for with an `inactive-ok:` comment at the citing site.
...
### [ADR-tmp8hp25](../../record/decisions.d/ADR-tmp8hp25.md) — Proposed

One config file, one format, vocabularies declared once

1 citation in 1 file awaits a look; 22 other citations of it are acknowledged.

- [`tests/test_vocabularies.py:178`](../../tests/test_vocabularies.py)
