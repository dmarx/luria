...
after the run that wrote it, and `luria index` stopped converging. Fixed here; the example is what
made it visible, about 26 hours after vocabularies shipped
