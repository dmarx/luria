...
**1 document cited without acknowledgement.** Not listed: 2 citations someone has already vouched for with an `inactive-ok:` comment at the citing site.
...
### [PRACTICE-004](../../record/practices.d/PRACTICE-004.md) — Superseded

Sign each conversational claim with its source inline

1 citation in 1 file awaits a look; 2 other citations of it are acknowledged.

- [`docs/practices/statuses/Superseded.md:11`](../practices/statuses/Superseded.md)
