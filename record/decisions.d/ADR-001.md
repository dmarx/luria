...
| layer | holds | test |
|---|---|---|
| `design-principles.md` | standing **values**, numbered, cited as "[DP-2](../../docs/design-principles.md#dp-2)" instead of re-argued | *have we re-derived this reasoning more than once?* |
