...
| layer | holds | test |
|---|---|---|
| `guiding-principles.md` | standing **values**, numbered, cited as "GP-2" instead of re-argued | *have we re-derived this reasoning more than once?* |
...
- **Decisions only** (the plain ADR practice). The common baseline, and it has
  ...
  each one, which is the cost [GP-2](../../docs/guiding-principles.md#gp-2) names in a
  different domain.
