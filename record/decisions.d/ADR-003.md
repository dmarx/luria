...
summary: >-
  ...
  drift, [GP-4](../../docs/guiding-principles.md#gp-4)).
---
...
of the audit's finding, and it is [GP-5](../../docs/guiding-principles.md#gp-5) at rung four.
...
- **Both, for readability.** Two copies of one fact, which is
  [GP-4](../../docs/guiding-principles.md#gp-4)'s definition of a latent bug. The frontmatter
