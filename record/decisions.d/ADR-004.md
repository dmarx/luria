...
summary: >-
  ...
  made it both a lock ([GP-2](../../docs/guiding-principles.md#gp-2)) and a drifting copy
  ([GP-3](../../docs/guiding-principles.md#gp-3)) — in strata-g, 45 of 155 rows disagreed with
...
lock [GP-2](../../docs/guiding-principles.md#gp-2) names, *and* the drifting projection
[GP-3](../../docs/guiding-principles.md#gp-3) names, since every row duplicated data the
...
- **Keep the table, add a test that it matches.** Rung 2 of
  [GP-3](../../docs/guiding-principles.md#gp-3) where rung 1 is available. The test would be
