---
status: 'Rejected — the README opens on what the record does, not on what to call it; the prior art belongs in the concepts page instead'
formerly:
- ADR-tmp0btsq
...
# ADR-058: Luria is a truth maintenance system, and should say so
