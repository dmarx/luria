...
# in `superseded_by: ADR-104` (a reference field: checked, resolved, an edge
...
# What the index shows in place of the code. Repeat it as the body's `# ADR-104:`
...
# ADR-104: A directive's argument list is syntax; its reason is prose
